#include<iostream>
#include<string.h>
#include<ctype.h> // library for conversion letter
using namespace std;
#define MAX 50
...
int main()  {
  ...
  obj.getString();
  obj.extractString();
  cout<<"\n -->The sentence extracted after removing punctuation and symbols";

  cout<<"\n -->The sentence converted to lower case";
  cout<<"\n -->Reverse of entered the sentence :: ";
  obj.displayReverse();
  obj.checkPalindrome();
  return 0;
}
...
void Stack::extractString() {
  ...
  length=j;   //update length with new sentence length
